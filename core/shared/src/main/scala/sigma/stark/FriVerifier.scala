...
/** FRI low-degree-test verifier — mirror of risc0-zkp 3.0.4
  ...
  * `stark-kat/src/bin/fri_kat.rs`) and by a replay of the REAL devnet
  * receipt's FRI phase (`stark-kats/transcript_capture.tsv`), per the
  * oracle-parity rule.
  */
object FriVerifier {
